...
use crate::proto::{
    ...
    ListSoundFontsResponse, ProposeScoreRequest, ProposeScoreResponse, RecordCourseCompletionRequest,
    RecordCourseCompletionResponse, RedeemRewardRequest, RedeemRewardResponse,
    RemoveSavedCatalogScoreRequest, RemoveSavedCatalogScoreResponse, RewardActivity, RewardShopItem,
    SaveCatalogScoreRequest, SaveCatalogScoreResponse, ScoreRecord, SearchCatalogRequest,
