...
async fn main() -> anyhow::Result<()> {
    ...
    let auth_cfg = AuthConfig::new(
        ...
        cymbra_auth::AuthLimits {
            signin_max_attempts: cfg.signin_max_attempts,
            signin_lockout: cfg.signin_lockout,
            signin_addr_max_failures: cfg.signin_addr_max_failures,
            signin_account_max_failures: cfg.signin_account_max_failures,
            signin_account_window: cfg.signin_account_window,
            email_max: cfg.email_max,
            email_window: cfg.email_window,
            email_addr_max: cfg.email_addr_max,
            email_addr_window: cfg.email_addr_window,
            email_account_max: cfg.email_account_max,
            email_account_window: cfg.email_account_window,
        },
        cfg.verify_ttl,
        cfg.reset_ttl,
