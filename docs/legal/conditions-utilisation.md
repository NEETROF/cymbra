<!--
  BROUILLON — à relire/compléter (champs «...») et idéalement faire valider par un
  juriste avant publication. Dernière mise à jour : «JJ/MM/AAAA».
-->
...
- Vous devez fournir une adresse email valide (ou vous connecter via Google/Apple) et
  garder vos identifiants confidentiels.
- Vous êtes responsable de l'activité sur votre compte.
- Vous pouvez **supprimer votre compte à tout moment** dans l'application ; la
  suppression est irréversible (voir la politique de confidentialité).

## 3. Utilisation acceptable

Vous vous engagez à ne pas : contourner la sécurité, abuser du service (charge
excessive, automatisation non autorisée), usurper l'identité d'autrui, ou utiliser
Cymbra à des fins illégales.
