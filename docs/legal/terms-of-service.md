<!--
  DRAFT — review/complete the «...» fields and ideally have a lawyer review it before
  publishing. English version of conditions-utilisation.md (keep both in sync; the
  French version is legally required for French consumers).
-->
