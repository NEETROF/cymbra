...
*Annex A — Cymbra Music* and *Annex B — Cymbra Lingua*).
...
- **Erasure (right to be forgotten)**: you can **delete your account directly in the
  ...
  personal data. Your account is shared by every Cymbra app, so deleting it applies to
  each of them (Cymbra Music, Cymbra Lingua).
- **Cymbra Lingua**: you can also erase **only** your Lingua data, without deleting your
  account (see *Annex B*).
...
| Review deck: the word, the sentence you found it in, its translation and its review state — **without** the page address | you | review on all your devices |
| Daily statistics (words learned, reviews, number of words met) | computed on the device | show your statistics; **aggregated** usage figures to run the service |
| Random installation identifier | generated by the extension | tell two devices apart during sync |

- **Legal basis**: performance of a contract (providing sync).
