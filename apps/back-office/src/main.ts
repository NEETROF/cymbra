...
if (import.meta.env.VITE_E2E) {
  ...
  // Silent refresh: on an expired access token, refresh once and retry rather than
  // signing the user out. Returns false (→ sign out) when there is no refresh token
