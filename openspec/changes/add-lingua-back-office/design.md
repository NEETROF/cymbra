...
- [Dépendance `add-lingua-id-sync` non mergée] → ce change ne compile pas sans le crate `backend/lingua` ; l'ordre d'implémentation est séquentiel, les specs peuvent être ratifiées en parallèle.
